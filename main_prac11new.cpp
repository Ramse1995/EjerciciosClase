...
float posX = 0, posY = 2.5, posZ = -3.5, rotRodIzq = 0 , rotRodDer = 0, manRodDer = 0,manRodIzq = 0, CARodIzq = 0;//variables para manipular al monito
float giroMonito = 0;
...
typedef struct _frame
{
	...
	float rotRodDer;//variable de rotacion pierna der
	float incrotRodDer;//incremento para la rotacion
	...
	float manRodDer;//variable de rotacion mano der
	float incmanRodDer;//incremento para la rotacion
	
	float manRodIzq;//variable de rotacion mano IZQ
	float incmanRodIzq;//incremento para la rotacion

	float CARodIzq;//variable de rotacion mano der
	float incCARodIzq;//incremento para la rotacion
}FRAME;
...
void saveFrame(void)
{
	...
	KeyFrame[FrameIndex].manRodDer = manRodDer;
	KeyFrame[FrameIndex].manRodIzq = manRodIzq;
	...
	KeyFrame[FrameIndex].CARodIzq = CARodIzq;
...
void resetElements( void )
{
	...
	manRodDer = KeyFrame[0].manRodDer;
	manRodIzq = KeyFrame[0].manRodIzq;
}
...
void interpolation ( void )
{
	...
	KeyFrame[playIndex].incmanRodDer = (KeyFrame[playIndex + 1].manRodDer - KeyFrame[playIndex].manRodDer) / i_max_steps;
	KeyFrame[playIndex].incmanRodIzq = (KeyFrame[playIndex + 1].manRodIzq - KeyFrame[playIndex].manRodIzq) / i_max_steps;
}
...
void InitGL ( GLvoid )     // Inicializamos parametros
{
	...
	for(int i=0; i<MAX_FRAMES; i++)
	{
		...
		KeyFrame[i].incrotRodDer = 0;
		KeyFrame[i].manRodDer = 0;
		KeyFrame[i].incmanRodDer = 0;
		KeyFrame[i].manRodIzq = 0;
		KeyFrame[i].incmanRodIzq = 0;
	}
	//NEW//////////////////NEW//////////////////NEW///////////
...
void animacion()
{
	...
	{		
		...
		else
		{
			...
			manRodDer += KeyFrame[playIndex].incmanRodDer;
			manRodIzq += KeyFrame[playIndex].incmanRodIzq;
			i_curr_steps++;
		}
