...
void animacion()
{
	...
	if (circuito)
	{
		...
		if (recorrido2)//estado B
		{
			rotKit = 90;
			movKitX++;
			if (movKitX > 125)//transicion a C limite 
			{
				recorrido2 = false;
				recorrido3 = true;
