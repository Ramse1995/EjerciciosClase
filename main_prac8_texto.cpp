...
void InitGL ( GLvoid )     // Inicializamos parametros
{
	...
	t_metal01.LoadTGA("Cube.tga");
	t_metal01.BuildGLTexture();
	t_metal01.ReleaseImage();

	t_Ajedrez2.LoadTGA("Cube.tga");
...
void prisma (GLuint textura1, GLuint textura2)  //Funcion creacion prisma
{
	...
	GLfloat vertice [8][3] = {
		...
		glBegin(GL_POLYGON);	//Front
			...
			glTexCoord2f(0.50f, 0.67f); glVertex3fv(vertice[0]);//11
			glTexCoord2f(0.25f, 0.67f); glVertex3fv(vertice[4]);//10
			glTexCoord2f(0.25f, 0.34f); glVertex3fv(vertice[7]);//01
			glTexCoord2f(0.50f, 0.34f); glVertex3fv(vertice[1]);//00
		glEnd();
	
		glBegin(GL_POLYGON);	//Right
			glNormal3f( 1.0f, 0.0f, 0.0f);
			glTexCoord2f(0.50f, 0.33f); glVertex3fv(vertice[0]);
			glTexCoord2f(0.75f, 0.33f); glVertex3fv(vertice[3]);
			glTexCoord2f(0.75f, 0.66f); glVertex3fv(vertice[5]);
			glTexCoord2f(0.50f, 0.66f); glVertex3fv(vertice[4]);
		glEnd();
		...
		glBegin(GL_POLYGON);  //Bottom
			...
			glTexCoord2f(0.50f, 0.0f); glVertex3fv(vertice[1]);
			glTexCoord2f(0.50f, 0.33f); glVertex3fv(vertice[2]);
		...
		glBegin(GL_POLYGON);  //Top
			...
			glTexCoord2f(0.50, 0.66f); glVertex3fv(vertice[5]);
			glTexCoord2f(0.50, 1.0f); glVertex3fv(vertice[6]);
